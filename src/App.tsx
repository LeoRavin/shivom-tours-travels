        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between justify-between h-20">
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="h-11 w-11 bg-gradient-to-br from-sky-600 to-blue-700 rounded-2xl flex items-center justify-between justify-center shadow-inner">
                <Car className="h-6 w-6 text-white" />
              </div>
              <div>
                <div className="font-bold text-2xl tracking-tighter text-red-500">Shivom</div>
                <div className="text-[10px] text-black-500 -mt-1">TOURS &amp; TRAVELS</div>
              </div>
            </div>

            {/* Desktop Navigation */}
            <div className="hidden md:flex items-center justify-between gap-9 text-sm font-medium">
              {[
    ...
    {isMenuOpen && (
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-40" onClick={() => setIsMenuOpen(false)}></div>
          ...
          <div className="fixed top-0 left-0 h-full w-full bg-white px-6 py-6 space-y-4 z-50">
            ...
            <div className="pt-4 flex flex-col gap-3">
              <button
                onClick={handleCall}
                className="w-full py-4 bg-sky-600 text-white rounded-3xl font-semibold flex items-center justify-between justify-center gap-2"
              >
                <Phone className="h-5 w-5" /> 99169 79567
              </button>
              <button
                onClick={handleWhatsApp}
                className="w-full py-4 border border-green-500 text-green-600 rounded-3xl font-semibold flex items-center justify-between justify-center gap-2"
              >
      ...
      <section id="home" className="relative h-screen flex items-center justify-between justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
          <div className="inline-flex items-center justify-between gap-2 bg-white/20 backdrop-blur-md px-5 py-1.5 rounded-3xl mb-6 text-sm tracking-widest font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button 
              onClick={handleCall}
              className="flex items-center justify-between justify-center gap-3 border-2 border-white/70 hover:border-white px-8 py-4 rounded-3xl font-semibold text-lg transition-all"
            >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              ...
              >
                <div className="h-16 w-16 bg-orange-50 text-orange-500 rounded-2xl flex items-center justify-between justify-center mb-8 group-hover:scale-110 transition-transform">
                  {service.icon}
                </div>
                <h3 className="font-semibold text-2xl mb-3 text-slate-900">{service.title}</h3>
                <p className="text-slate-600 leading-relaxed">{service.desc}</p>
                <div className="mt-8 pt-8 border-t text-orange-500 text-sm font-medium flex items-center justify-between gap-2 group-hover:gap-3 transition-all">
            ...
            {vehicles.map((vehicle, i) => (
              <div key={i} className="group bg-slate-800 rounded-3xl overflow-hidden border border-slate-700 hover:border-orange-400 transition-all">
                <div className="h-64 relative">
                  ...
                  />
                  <div className="absolute top-6 right-6 bg-black/70 px-4 py-1 text-xs rounded-3xl flex items-center justify-between gap-1">
                    {vehicle.icon}
      ...
      <section id="contact" className="py-24 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <div className="text-slate-400 text-sm mt-3">Available 6:00 AM - 12:00 PM</div>
                </div>
              </div>
          ...
          {/* Fake Map */}
          <div className="relative rounded-3xl overflow-hidden border border-slate-700 h-96 md:h-auto bg-slate-800 flex items-center justify-between justify-center">
            <div className="text-center">
              <div className="mx-auto mb-6 h-20 w-20 bg-white/10 backdrop-blur rounded-2xl flex items-center justify-between justify-center">
                📍
              </div>
            ...
            <div className="absolute bottom-8 left-8 bg-white/90 text-slate-900 text-xs px-5 py-3 rounded-2xl flex items-center justify-between gap-2 shadow">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-12 gap-y-16">
          <div className="md:col-span-5">
            <div className="flex items-center justify-between gap-3 text-white mb-6">
              <div className="h-9 w-9 bg-white rounded-2xl flex items-center justify-between justify-center">
                <Car className="h-5 w-5 text-slate-950" />
              </div>
              <div className="font-bold text-3xl tracking-tighter"></div>
            </div>
            ...
            <div className="mt-8 flex gap-5">
              {[
                ...
                <a
                  ...
                  className="h-9 w-9 border border-slate-700 hover:border-orange-400 hover:bg-orange-400/10 transition-colors rounded-2xl flex items-center justify-between justify-center text-xl"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div className="md:col-span-4">
            ...
            <div className="space-y-5">
              <a href="tel:9916979567" className="block hover:text-white flex items-center justify-between gap-4 group">
              ...
              <a href="mailto:kanakaraj1590@gmail.com" className="block hover:text-white flex items-center justify-between gap-4 group">
                <div className="h-9 w-9 flex items-center justify-between justify-center bg-white/5 rounded-2xl group-hover:bg-white/10 transition">✉</div>
                <div>
